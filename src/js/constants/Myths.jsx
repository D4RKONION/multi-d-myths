const MYTHS = [
  ...
  },  
  {
    ...
    "answer": "Of course they do! This one is just totally made up 🇮🇪\n\nThe curriculum being taught in all public Irish primary schools is **identical**. The only thing that's different is what happens during the 30 minutes a day designated as *The Patron's Half Hour (Religion in Catholic Schools)*.\n\nIn Catholic schools this time is used for faith formation. In Multi-D schools, students are taught about all belief systems from an objective point of view, as well as Ethics & The Environment, Equality & Justice, and Moral & Spiritual growth.\n\nYou can learn more about Educate Together's *Learn Together* curriculum [here](https://www.educatetogether.ie/app/uploads/2019/02/Learn-Together.pdf) or Community National School's *Goodness Me, Goodness You* [here](https://cns.ie/goodness-me-goodness-you-new/) 📝"
  },  
  {
    "index": 8,
    "myth": "Multi-D schools have too many foreigners/middle class kids/working class kids/etc.",
    "answer": "There are so many 'Multi-D schools have too many X students' myths running around out there that it's honestly hard to keep them all straight in my head! 😵\n\nMulti-D schools are as diverse as Catholic schools, both of which are full of all kinds of wonderful children just looking to get an education and feel like they belong to a community. Isn't that the most important thing about schools after all?"
  },  
  {
    "index": 9,
  ...
  },  
  {
    ...
    "answer": "The roots of this myth seem to be from the Educate Together ethos, which state that their schools must be democratically run. Parental involvement is certainly encouraged, but it has to be meaningful and have purpose. That is to say that parents are invited in if support is needed. There's no open door policy as many Irish teachers seem to think there is.\n\nIn other words, it's exactly the same as it is in Catholic schools!\n\nAlso I don't know about you, but every parent I know is extremely busy living their life and getting work done while kids are at school... Most parents don't have the time to be sitting at the back of the classroom all day, even if this was true 🤯"
  },  
  {
    "index": 11,
    "myth": "Multi-D schools are anti-religion, and they don't let anyone talk about God",
    "answer": "That couldn't be further from the truth! Both Educate Together and Community National schools teach about the six main belief systems, both religious and non-religious. That means that children learn about many of the various gods and deities out there. All belief systems in the classroom are respected in Multi-D schools.\n\nWorship is what's removed from Multi-D schools. Parents who want their children to learn to worship can get together with their local parish and organise after-school faith lessons. Sometimes an external faith formation teacher from the area will lead the way on this. In this way, their religion is no longer watered down to appeal to as broad a church as possible (excuse the pun) 😇.\n\nAnd of course parents of other belief systems can equally organise faith formation classes outside of school hours."
  },  
  {
    "index": 12,
    "myth": "Catholic schools are statistically high-achieving schools academically and we shouldn't give that up",
    "answer": "This is an argument that some people make, using data from abroad. However, in those countries, Catholic schools are generally private & hard to get into. As you can imagine, most people who can afford to send their kids to schools like those are well-off, and thus the grades coming out of the schools tend to be higher as parents from well-off families are able to give their children more advantages in life with all that extra cash 💴\n\n However, the important thing to note here is that the academic achievements of these schools abroad is in **no way linked to Catholic values**. It's linked to the wealth of the families attending those schools. Here in Ireland, the vast majority of students attend Catholic schools and so, their academic achievement is on average... average!"
  },  
  {
    "index": 13,
  ...
  },  
  {
    ...
    "answer": "There's not much to say about this one. It's nonsense. All Irish Primary School teachers have to do the same Bachelor of Education, PME, or an equivalent Degree from abroad plus an Irish cert when they return.\n\nWithout those things, they can't get a Teaching Council number, and without that they can't teach in any public Irish primary school. End of story."
  },  
  {
    "index": 15,
