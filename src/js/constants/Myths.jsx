const MYTHS = [
  ...
  {
    "index": 5,
    "myth": "The school would have to change it's name",
    "answer": "Yes, but it may not be as big a change as you might think.\n\nIn the case where the school is named after an area, it would simply get 'Educate Together' or 'Community' added it to. For example 'Cloontuskert National School' would become 'Cloontuskert *Community* National School' or 'Cloontuskert *Educate Together* National School'.\n\nIn the cases where there's a saint name, it would probably be renamed after the area as above."
  },
  {
    "index": 6,
